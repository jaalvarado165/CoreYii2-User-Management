...
$this->title = Yii::t('app', 'Permisos y roles') . ' : '. $role->description;
...
<p>
	<?= GhostHtml::a(Yii::t('app', 'Editar'), ['update', 'id' => $role->name], ['class' => 'btn btn-sm btn-primary']) ?>
...
<div class="row">
	<div class="col-sm-4">
		<div class="panel panel-default">
			<div class="panel-heading">
				<strong>
					<span class="glyphicon glyphicon-th"></span> <?= Yii::t('app', 'Roles hijos') ?>
				</strong>
			</div>
	...
	<div class="col-sm-8">
		<div class="panel panel-default">
			<div class="panel-heading">
				<strong>
					<span class="glyphicon glyphicon-th"></span> <?= Yii::t('app', 'Permisos') ?>
				</strong>
			</div>
			<div class="panel-body">
