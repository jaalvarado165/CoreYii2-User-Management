...
$this->title =Yii::t('app', 'Cambiando permisos para') . ': ' . $item->description;
...
<p>
	<?= GhostHtml::a(Yii::t('app', 'Editar'), ['update', 'id' => $item->name], ['class' => 'btn btn-sm btn-primary']) ?>
	...
	<div class="col-sm-6">
		<div class="panel panel-default">
			<div class="panel-heading">
				<strong>
					<span class="glyphicon glyphicon-th"></span> <?= Yii::t('app', 'Permisos hijos') ?>
				</strong>
			</div>
			<div class="panel-body">
				...
				<hr/>
				<?= Html::submitButton(
					'<span class="glyphicon glyphicon-ok"></span> ' . Yii::t('app', 'Guardar'),
				...
				<div class="row">
					...
					<div class="col-sm-3 text-right">
						<span id="show-only-selected-routes" class="btn btn-default btn-sm">
							<i class="fa fa-minus"></i> <?= Yii::t('app', 'Mostrar solo seleccionados') ?>
						</span>
						<span id="show-all-routes" class="btn btn-default btn-sm hide">
							<i class="fa fa-plus"></i> <?= Yii::t('app', 'Mostrar todo') ?>
						</span>
